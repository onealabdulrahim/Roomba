...
SENSORS = {
    ...
    "LEFT_ENCODER": SensorModule(chr(43), "TWO_BYTE_UNSIGNED", 2),
    "RIGHT_ENCODER": SensorModule(chr(44), "TWO_BYTE_UNSIGNED", 2)
}
        ...
        # otherwise, we try to open the numeric serial port...
            ...
            try:
                self.ser = serial.Serial(
                    PORT - 1, baudrate=115200, timeout=0.1)
                if (sim_mode):
                    self.init_sim_mode()
...
#======================= CARGO BAY OUTPUTS ==========================
    ...
    def setDigitalOutputs(self, digOut2, digOut1, digOut0):
        ...
        data_byte = int("00000" + str(digOut2) +
                        str(digOut1) + str(digOut0), 2)
    ...
    def setLowSideDrivers(self, driver2, driver1, driver0):
        ...
        data_byte = int("00000" + str(driver2) +
                        str(driver1) + str(driver0), 2)
